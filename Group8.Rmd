...
# Using lfe package for *state* and *year* as fixed effects variables and fit a model 
library(lfe)
...
# Use plm package tfor *state* and *year* as fixed effects variables and fit a model
library(plm)
